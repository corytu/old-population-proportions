...
# gcloud compute firewall-rules create shiny-conn --allow=tcp:3838 --target-tags shiny-server
gcloud compute instances add-tags instance-1 --tags shiny-server --zone asia-east1-b
